         ...
         <div class="text-left">
          <div class="row">
           ...
           <tr>
            ...
            <td>      <button class="btn btn-primary  btn-block waves-effect waves-light" style="width:50%;" onclick="searchtesting();" id="btnlogin" type="button">Salman<i class="fas fa-sign-in-alt ml-1"></i></button></td>
          </tr>
        </table>
      </div>
    </div>
...
<div class="row">
  ...
  <div class="col-md-2">
          ...
          style="border:1px solid green !important; background-color:green !important ; width:100%;" onclick="Search2(this.value);" id="paycashwithoutprint" type="button" value="paycashwithoutprint">Go Green </button>
  </div>
  <div class="col-md-2">
