...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>IT Inventory | Taj Corporation</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Taj Corporation" name="description" />
        <meta content="Taj Corporation" name="author" />
                        ...
                        <div class="card-body">
                            <div class="px-3">
                                <div class="auth-logo-box">
                                    <a href="assets/images/tajlogo.png" class="logo logo-admin"><img src="assets/images/tajlogo.png" height="55" alt="logo" class="auth-logo"></a>
